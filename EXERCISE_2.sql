...
-- DROP CONSTRAINT WITH CONSTRAINT NAME 
...
ALTER TABLE VOTERS ADD PRIMARY KEY (LIC_NO,HOLDER_NAME);

ALTER TABLE VOTERS ADD UNIQUE (CITY);

-- DROP CONSTRAINT WITHOUT CONSTRAINT NAME 
ALTER TABLE VOTERS DROP CONSTRAINT SYS_C00165157627;
